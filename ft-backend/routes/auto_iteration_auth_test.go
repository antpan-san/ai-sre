...
func setupDB(t *testing.T) {
	...
	stmts := []string{
		...
		`CREATE TABLE auto_iteration_feedbacks (id TEXT PRIMARY KEY, tenant_id TEXT, created_at DATETIME, updated_at DATETIME,
			...
			user_message TEXT, source TEXT, request_id TEXT, execution_id TEXT, command TEXT, summary TEXT,
			skill_name TEXT, helpful INTEGER, rule_hit INTEGER, used_ai INTEGER, evidence_completeness TEXT,
			root_cause_digest TEXT, recommendation_digest TEXT, evidence_digest TEXT,
			raw_payload TEXT, auto_iteration_id TEXT)`,
		...
		`CREATE TABLE cli_bindings (id TEXT PRIMARY KEY, tenant_id TEXT, created_at DATETIME, updated_at DATETIME,
			user_id TEXT, username TEXT, token_hash TEXT, fingerprint_hash TEXT, hostname TEXT, os TEXT, arch TEXT,
			install_user TEXT, version TEXT, last_used_at DATETIME, expires_at DATETIME, revoked_at DATETIME)`,
		`CREATE TABLE skill_tree_versions (id TEXT PRIMARY KEY, tenant_id TEXT, created_at DATETIME, updated_at DATETIME,
			tree_rev TEXT, status TEXT, title TEXT, notes TEXT, published_by TEXT, published_at DATETIME)`,
		`CREATE TABLE skill_tree_nodes (id TEXT PRIMARY KEY, tenant_id TEXT, created_at DATETIME, updated_at DATETIME,
			tree_rev TEXT, path TEXT, parent_path TEXT, node_type TEXT, title TEXT, description TEXT,
			topic TEXT, skill_key TEXT, problem_key TEXT, capability_key TEXT, pack_key TEXT, feature_key TEXT,
			execution_mode TEXT, cli_visible INTEGER, status TEXT, sort_order INTEGER, metadata TEXT)`,
	}
	for _, s := range stmts {
