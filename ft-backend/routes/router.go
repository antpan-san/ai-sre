...
func SetupRouter(cfg *config.Config) *gin.Engine {
	...
	protected.Use(middleware.JWTAuth(cfg.JWT.SecretKey))
	{
		...
		superAdmin.GET("/admin/skill-commercial/products", handlers.AdminListCommercialProducts)
		superAdmin.GET("/admin/skill-commercial/bindings", handlers.AdminListCommercialBindings)
		superAdmin.POST("/admin/skill-commercial/bindings", handlers.AdminCreateCommercialBinding)
		superAdmin.DELETE("/admin/skill-commercial/bindings/:id", handlers.AdminDeleteCommercialBinding)
		...
		svcAdmin.GET("/service-deploy/deployments", middleware.RequireCapability(models.FeatureKeyNodeOps, middleware.CapabilityActionView), handlers.ListServiceDeployments)
